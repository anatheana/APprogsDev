...
MODULE File_Utility
  ...
  !! If file exists, for file name and unit
  INTERFACE File_Exists
    MODULE PROCEDURE File_Unit_Exists
    MODULE PROCEDURE File_Name_Exists
  END INTERFACE

  !! If file is open, for file name and unit
  INTERFACE File_Open
...
!-------------------------------------------------------------------------------
!
! $Id: File_Utility.f90,v 1.12 2004/08/11 20:34:41 paulv Exp $
!
! $Date: 2004/08/11 20:34:41 $
!
! $Revision: 1.12 $
!
! $Name:  $
